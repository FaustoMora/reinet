...
class Consultor(models.Model):
    ...
    usuario = models.ForeignKey(Persona, db_column="usuario_idUsuario", null=True)
    tipo = models.ForeignKey(Catalogo, db_column="tipoConsultor", null=True)
...
class Incubacion(models.Model):
    ...
    fechaInicio = models.DateField(null=True, auto_now=True, db_column="fechaInicioIncubacion")
    nombre = models.CharField(null=True, max_length=50, db_column="nombreIncubacion")
    alias = models.CharField(null=True, max_length=50, db_column="aliasIncubacion")
    descripcion = models.CharField(null=True, max_length=50, db_column="descripcionIncubacion")
    condiciones = models.CharField(null=True, max_length=30L, db_column="condicionesIncubacion")
    perfilOfertas = models.CharField(null=True, max_length=30L, db_column="perfilOfertas")
    tipoOfertas = models.ManyToManyField(Catalogo, through="TiposOfertasIncubacion", related_name="incubaciones",null=True)
    alcance = models.ForeignKey(Catalogo, null=True, db_column="alcanceIncubacion", related_name="alcance")
    condicionesAdicionales = models.CharField(null=True, max_length=30L, db_column="condicionesAdicionales")
    estado = models.ForeignKey(Catalogo, db_column="estadoIncubacion", related_name="estado")
    razonEstado = models.CharField(null=True, max_length=50, db_column="razonEstadoIncubacion")
...
class IncubacionConsultor(models.Model):
    ...
    consultor = models.ForeignKey(Consultor, null=True, db_column="consultor_idConsultor")
...
class InvitacionConsultor(models.Model):
    ...
    incubacion = models.ForeignKey(Incubacion, null=True, db_column="incubacion_idIncubacion")
    invitado = models.ForeignKey(Persona, null=True, db_column="persona_idPersona")
    estado = models.ForeignKey(Catalogo, null=True, db_column="estadoInvitacionIncubacion")
...
class Milestone(models.Model):
    ...
    fechaCumplimiento = models.DateField(null=True, db_column="fechaVencimiento")
...
class Incubada(models.Model):
    ...
    incubacion = models.ForeignKey(Incubacion, null=True, db_column="incubacion_id_incubacion",related_name="incubadas")
    oferta = models.ForeignKey(Oferta, null=True, db_column="oferta_idOferta")
...
class ConsultorIncubada(models.Model):
    ...
    consultor = models.ForeignKey(Consultor, null=True, db_column="usuario_idUsuario")
...
class CamposAdicionalesMilestone(models.Model):
    ...
    milestone = models.ForeignKey(Milestone, null=True, db_column="Milestone_idMilestone")
    descripcion = models.CharField(null=True, max_length=300, db_column="descripcionCamposAdicionalesMilestone")
    """importancia = models.ForeignKey(Catalogo, null=True, db_column="importanciaCamposAdicionales")"""
...
class Retroalimentacion(models.Model):
    ...
    milestone = models.ForeignKey(Milestone, null=True, db_column="Milestone_idMilestone")
    incubada = models.ForeignKey(Incubada, null=True, db_column="Incubada_idIncubada")
    mensaje = models.CharField(max_length=30L, null=True, db_column="mensajeRetroalimentacion")
...
class ConvocatoriaIncubacion(models.Model):
    ...
    incubacion = models.ForeignKey(Incubacion, null=True, db_column="incubacion_idIncubacion")
    fechaInicio = models.DateField(null=True, db_column="fechaInicioConvocatoria")
    fechaFin = models.DateField(null=True, db_column="fechaFinConvocatoria")
...
class ConvocatoriaIncubacionOfertas(models.Model):
    ...
    convocatoria = models.ForeignKey(ConvocatoriaIncubacion, null=True, db_column="ConvocatoriaIncubacion_idConvocatoriaIncubacion", related_name="convocatoria")
    oferta = models.ForeignKey(Oferta, null=True, db_column="oferta_idOferta")
    estado = models.ForeignKey(Catalogo, null=True, db_column="estadoSolicitud", related_name="estado_solicitud")
...
class TiposOfertasIncubacion(models.Model):
    ...
    incubacion = models.ForeignKey(Incubacion, null=True, db_column="incubacion_idIncubacion")
    tipo = models.ForeignKey(Catalogo, null=True, db_column="catalogo_idCatalogo")
