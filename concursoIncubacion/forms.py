...
class CrearIncubacionForm(forms.ModelForm):
	...
	fecha_inicio = forms.DateField(label="Fecha Inicio",widget=forms.DateInput(format=('%d/%m/%y'),attrs={'class':'form-control','placeholder':'Fecha inicio de la incubada (m/d/Y)','required':''}))
