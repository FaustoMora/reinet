...
function nuevoCon(){
    ...
    nuevoC.setAttribute("placeholder", "Ingrese un nuevo miembro");
	
	var br = document.createElement("br");
	
    consultant.insertBefore(nuevoC, addConsultant);
	consultant.insertBefore(br, addConsultant);
}
...
function nuevoJur(){
	...
	judge.insertBefore(br, addJudge);
}
...
function nuevoSco(){
	...
	scope.insertBefore(br, addScope);
}
