...
tiempo_inicio_disponible = forms.DateField(label="Fecha Inicio",widget=forms.DateInput(format=('%d/%m/%y'),attrs={'class':'form-control','placeholder':'Fecha inicial de la oferta (m/d/Y)','required':''}))
tiempo_fin_disponible = forms.DateField(label="Fecha Final",widget=forms.DateInput(format=('%d/%m/%y'),attrs={'class':'form-control','placeholder':'Fecha fin de la oferta (m/d/Y)','required':''}))
...
evidencia_traccion = forms.CharField(label="Evidencia de traccion",widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Ingrese evidencia de traccion','data-trigger':'focus','data-placement':'left','data-toggle':'popover', 'required':''}))
